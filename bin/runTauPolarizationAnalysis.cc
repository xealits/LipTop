  ...
  for( int iev=evStart; iev<evEnd; iev++)
    {
      ...
      kin.runOn(ev, &stdPtResol,&stdEtaResol,&stdPtResol,totalUnc); // TODO: calculate tau polarization here
    }
  kin.endAnalysis();

  // TODO save tau polarization here, probably in another format
